<?php /* Smarty version Smarty-3.0.7, created on 2012-05-26 15:07:33
         compiled from "application/views/templates\contact_us.tpl" */ ?>
<?php /*%%SmartyHeaderCode:131024fc0d595060947-73831722%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8cc36904eac5385cc83232fd972761fe85e90b1b' => 
    array (
      0 => 'application/views/templates\\contact_us.tpl',
      1 => 1338029646,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '131024fc0d595060947-73831722',
  'function' => 
  array (
  ),
...
$_template->assign('url',($_smarty_tpl->getVariable('url')->value));$_template->assign('title',($_smarty_tpl->getVariable('title')->value)); echo $_template->getRenderedTemplate();?><?php unset($_template);?>
  		...
  		<?php $_template = new Smarty_Internal_Template("htmlincludes/contact_us.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
$_template->assign('url',($_smarty_tpl->getVariable('url')->value));$_template->assign('title',($_smarty_tpl->getVariable('title')->value)); echo $_template->getRenderedTemplate();?><?php unset($_template);?>
		</div>
